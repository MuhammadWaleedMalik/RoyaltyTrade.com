...
import esBlog from '../data/text/es/blog.json';
...
const Blogs = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="relative w-full py-20 bg-black">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 text-left">
          <motion.h1
            ...
            className="text-4xl sm:text-8xl md:text-6xl font-bold text-white mb-6"
          >
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-16 flex flex-col md:flex-row gap-8">
        {/* Blog Posts */}
        <div className="md:w-2/3">
          {pageContent.posts.map((post, index) => (
            ...
            >
              ...
              />
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{processText(post.title)}</h2>
              <p className="text-gray-700 leading-relaxed mb-4">{processText(post.excerpt)}</p>
